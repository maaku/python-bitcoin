...
CHAIN_PARAMETERS = {
    ...
    'freico.in' : ChainParameters(
        ...
        alert_keys = [],
        checkpoints = {
            0:     0x000000000c29f26697c30e29039927ab4241b5fc2cc76db7e0dafa5e2612ad46,
